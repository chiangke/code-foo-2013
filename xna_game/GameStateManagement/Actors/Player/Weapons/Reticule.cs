...
namespace GameStateManagement
{
    ...
    public class Reticule : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        public void UpdateRay()
        {
            ...
            foreach (Enemy A in EnemyManager.enemyList)  //Iterate through the Asteroids list and check whether ray is true.
            {
                if(raycast.Intersects(A.WorldBounds) != null && A.Position.Z+50 < Ship.ShipPosition.Z)
                {
                    enemyPointer = A;
                    isTargeted = true;
